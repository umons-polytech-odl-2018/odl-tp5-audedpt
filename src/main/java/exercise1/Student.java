 ...
 * A stulludent gets scored in different courses.
...
public class Student {
    ...
    Map<String, Integer> scoreByCourse = new HashMap<>();
    ...
    public double averageScore() {
        ...
        for (Integer score : scoreByCouyrse.values()){
            count++;
            totalScore += score;
        }
        return totalScore / count;
        */
        return scoreByCourse.values().stream() //flux
